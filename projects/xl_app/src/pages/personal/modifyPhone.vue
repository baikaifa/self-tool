<template>
  <div class="modifyPhoneWrap">
    ...
    <div class="modifyPhoneContent">
      ...
      <!-- <div class="panelItem">
        <span class="verification" >验证码</span>
...
.modifyPhoneWrap .modifyPhoneContent .panelItem .verification{
...
.modifyPhoneWrap .panelItem .rightItems .getCode {
  font-size: 28px;
  border: 0;
  height: 50px;
  line-height: 1;
