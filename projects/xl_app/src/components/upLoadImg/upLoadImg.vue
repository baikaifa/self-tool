    ...
    <div class="file-list">
      ...
      <div class="thumbnails my-gallery">
        <figure itemprop="associatedMedia" itemscope  class="thumbnail" v-for="(item,index) in files" :key="index">
          <a :href="item" itemprop="contentUrl" data-size="400x400" class="img-wrapper">
            <img :src="item" itemprop="thumbnail"/>
        ...
        <section class="thumbnail" v-if="this.files.length < 9">
          <div class="add">
            <span><img src="../../assets/img/addBtn_03.jpg" alt=""></span>
  ...
  export default {
    ...
    methods: {
      ...
      selectImgs() {
        ...
        let _that = this;
        console.log(this.$refs.file.files,'3434343')
      ...
      renderImg:function (data) {
        console.log(data,'dasdasdsaasd')
        this.files = data.concat([]);
      },
      renderImgOne:function (data) {
        this.files = data.concat([]);
      }
    },
    mounted() {
